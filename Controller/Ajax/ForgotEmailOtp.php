 ...
 */
class ForgotEmailOtp extends \Magento\Framework\App\Action\Action
{
    ...
    */
    ...
    public function execute()
    {
        ...
        $response = [
            'errors' => false,
            'message' => __('OTP successfully sent to your email.
                             Enter the One-time-password for verification
                             If you didn’t receive the code, resend it.')
        ];
        ...
        try {
            ...
            $customerFullName = $getCustomerData['firstname'].$getCustomerData['lastname'];
